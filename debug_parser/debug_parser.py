...
@app.route('/api/save_title_solution/<int:parser_debug_id>', methods=['POST'])
...
def api_save_title_solution(parser_debug_id):
    ...
    parser_debug_id = parser_debug_id  # Now using parser_debug_id as the main reference
...
@app.route('/api/title_strategy/recipe_word/<int:parser_debug_id>', methods=['GET'])
...
@app.route('/api/title_strategy/url_match/<int:parser_debug_id>', methods=['GET'])
...
@app.route('/parser_debug_raw/<int:parser_debug_id>')
@require_role('Admin')
...
@app.route('/parser_debug/<int:parser_debug_id>')
@require_role('Admin')
def parser_debug(parser_debug_id):
    ...
    with get_db_connection() as conn:
        ...
        confirmed_list = [dict(row) for row in all_rows if row.get('parser_debug_id') == parser_debug_id] if all_rows else []
