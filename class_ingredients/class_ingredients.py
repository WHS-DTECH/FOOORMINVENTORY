...
class_ingredients_bp = Blueprint('class_ingredients', __name__, template_folder='templates/class_ingredients')

@class_ingredients_bp.route('/class_ingredients', methods=['GET', 'POST'])
